...
public class CoachDashboardBean implements Serializable {
    ...
    public void charger() {
        ...
        chargerCoach(u.getId());
        chargerSeances(u.getId());
        chargerMembres(u.getId());
    ...
    public void sauvegarderSeance() {
        ...
        try {
            ...
            if (!modeEditionSeance) {
                ...
                if (u != null) {
                    try (Session s = HibernateUtil.getSessionFactory().openSession()) {
                        Coach coachDb = s.get(Coach.class, u.getId());
    ...
    public void sauvegarderProfil() {
        ...
        if (email != null
                ...
                && utilisateurDAO.emailExistsExcept(email, u.getId())) {
            ctx.addMessage(null, new FacesMessage(
                    FacesMessage.SEVERITY_ERROR,
                    "Email utilisé",
        ...
        try (Session s = HibernateUtil.getSessionFactory().openSession()) {
            ...
            Utilisateur uM = s.get(Utilisateur.class, u.getId());
            if (uM == null) {
                ctx.addMessage(null, new FacesMessage(
                        FacesMessage.SEVERITY_ERROR,
                        "Erreur",
            ...
            Coach cM = s.get(Coach.class, u.getId());
            if (cM != null) {
